...
angular.module('ptlab')
    ...
    .controller('PanelDialogController', PanelDialogCtrl);

function PanelController($mdPanel) {
  this._mdPanel = $mdPanel;
  this.disableParentScroll = false;
}

PanelController.prototype.showDialog = function() {
...
PanelController.prototype.showMenu = function(ev) {
  var position = this._mdPanel.newPanelPosition()
